...
[![Version](https://img.shields.io/badge/Version-1.4.1-emerald.svg)](version.json)
...
- **WebUI Version Checker**: Header widget displays the current version (`v1.4.1`) with a single-click update checker.
...
- **Έλεγχος Έκδοσης στο WebUI**: Εμφάνιση της τρέχουσας έκδοσης (`v1.4.1`) στην κεφαλίδα με κουμπί ελέγχου νεότερης έκδοσης.
